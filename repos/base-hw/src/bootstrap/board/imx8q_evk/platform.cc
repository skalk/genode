		0x00000016, 0x00001816, 0x00000016, 0x00000016,
		0x00000016, 0x00000016, 0x00000019, 0x00000016,
		0x00000016, 0x00000045, 0x00000045, 0x00001816,
		0x00000016, 0x00000016, 0x00000016, 0x0000007f,
		0x0000007f, 0x00000016, 0x00000016, 0x0000007f,
		0x0000007f, 0x0000007f, 0x0000007f, 0x00000045,
		0x00000045, 0x00000045, 0x00000045, 0x00000045,
		0x00000045, 0x00000016, 0x00000016, 0x00000000,
		0x00000001, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
	...
	volatile Genode::uint32_t * iomuxc_base = (volatile Genode::uint32_t *)0x30330000;
	for (unsigned i = 0;
		 i < (sizeof(iomuxc_values_1)/sizeof(Genode::uint32_t));
		 i++) {
		if (*iomuxc_base != iomuxc_values_1[i]) {
			Genode::log(iomuxc_base, " ", Genode::Hex(iomuxc_values_1[i]));
		}
		*iomuxc_base = iomuxc_values_1[i];
		iomuxc_base++;
	}

	Genode::uint32_t iomuxc_values_2[] = {
		0x00000000, 0x00000000, 0x00000000, 0x00000fff,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00010009, 0x00000000,
		0x00004400, 0x00000004, 0x49409000, 0x6188ffff,
		0x49409200, 0x6188ffff, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x000e0000, 0x00000000,
		0x00180000, 0x06400a20, 0x0000000a, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000800, 0x00010000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000800, 0x00010000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x00000000, 0x00000000,
	...
	iomuxc_base = (volatile Genode::uint32_t *)0x30340000;
	for (unsigned i = 0;
		 i < (sizeof(iomuxc_values_2)/sizeof(Genode::uint32_t));
		 i++) {
		if (*iomuxc_base != iomuxc_values_2[i]) {
			Genode::log(iomuxc_base, " ", Genode::Hex(iomuxc_values_2[i]));
		}
		*iomuxc_base = iomuxc_values_2[i];
		iomuxc_base++;
	}
