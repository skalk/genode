...
#ifndef _SRC__INCLUDE__HW__SPEC__ARM__VIRT_QEMU__BOARD_H_
#define _SRC__INCLUDE__HW__SPEC__ARM__VIRT_QEMU__BOARD_H_
...
#endif /* _SRC__INCLUDE__HW__SPEC__ARM__VIRT_QEMU__BOARD_H_ */
