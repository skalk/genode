...
struct Driver::Ccm
{
	...
	//TODO: add IPG root clock divider
	...
	//Gate mu_gate         { "mu_gate",         gate_base(33),  , tree };
	//Gate ocotp_gate      { "ocotp_gate",      gate_base(34),  , tree };
	...
	//Gate sdma1_gate      { "sdma1_gate",      gate_base(58),  , tree };
	//Gate sdma2_gate      { "sdma2_gate",      gate_base(59),  , tree };
	...
	//Gate tempsensor_gate { "tempsensor_gate", gate_base(98),  , tree };
